...
* **Sampled and weighted values** (class `list[ndarray]`):
  ...
  * `samples, dist = ap.sampled_values(image, return_dist=True)` also returns Euclidean pixel-center distances from each aperture center, aligned with the sampled values.
